...
@section("context")
    ...
    <div class="container-fluid">
        ...
        $breadcrumb[] = array("编辑内容", $baseURL ."/help/update/" . $id ."/".$type);
        ?>
                    ...
                    <div class="portlet-body form">
                        <form id="updateContentForm" action="#" class="form-horizontal">
                                    ...
                                    <div class="controls">
                                        <select class="span6 chosen" tabindex="1" id="type" name="type">
                                            @foreach($contentType as $ctype)
                                                <option value="{{{$ctype->id}}}" @if($help->type == $ctype->id)selected @endif>{{{$ctype->name}}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="large m-wrap" rows="3" name="brief" id="brief">{{{$help->brief}}}</textarea>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio">
                                        <input type="radio" name="display" value="1" @if($help->display != \App\Module\ContentModule::STATUS_CLOSE) checked @endif/>
                                        是
                                    </label>
                                    <label class="radio">
                                        <input type="radio" name="display" value="2" @if($help->display == \App\Module\ContentModule::STATUS_CLOSE) checked @endif/>
                                        否
                                    </label>
                                </div>
                            </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls input-prepend" style="margin-left:20px;">
                                        ...
                                        <input class="span12 m-wrap m-ctrl-medium date-picker" name="startTime" id="startTime" readonly
                                               type="text" @if($help->start_time) value="{{{date("m/d/Y", $help->start_time)}}}" @endif/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls input-prepend" style="margin-left:20px;">
                                        <span class="add-on"><i class="icon-remove"></i></span>
                                        <input class="m-wrap m-ctrl-medium date-picker" style="width:167px;" id="endTime" name="endTime" readonly
                                               type="text" @if($help->end_time) value="{{{date("m/d/Y", $help->end_time)}}}" @endif/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="source" name="source" value="{{{$help->source}}}"
                                           class="span6 m-wrap popovers" data-trigger="hover"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="sort" name="sort" value="{{{$help->sort}}}"
                                           class="span6 m-wrap popovers" data-trigger="hover"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="author" name="author" value="{{{$help->author}}}"
                                           class="span6 m-wrap popovers" data-trigger="hover"/>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="submit" id="JsSaveBtn" class="btn blue">更新</button>
                            </div>
                        </form>
                    </div>
                </div>
...
@section('otherJs')
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            var content = '<?php echo $help->content; ?> ';
            ue.ready(function() {

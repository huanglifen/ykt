...
@section("context")
    ...
    <div class="container-fluid">
        <?php
        $breadTitle = "活动专题";
        $breadcrumb = array(array("内容管理"), array("活动专题", $baseURL . '/subject/index'));
        ?>
                    ...
                    <div class="portlet-body">
                        <div class="clearfix">
                            <div class="btn-group span2">
                                <a href="{{{$baseURL}}}/subject/add" class="btn margin-right-10 green">
                                    新增<i class="icon-plus"></i>
                                </a>
                            </div>
                            <div class="row-fluid span10 pull-right" >
                                <div class="control-group span3">
                                        <div class="control-label" style="float: left;width:63px;padding-top:5px;">活动状态</div>
                                        <div class="controls">
                                ...
                                <div class="control-group span2">
                                    <div class="input-append">
                                        <input class="span12 m-wrap" type="text" id="title" name="title" placeholder="活动标题">
    ...
    <script>
        $(function () {
            ...
            var tbl = $('#datatable_content').dataTable({
                ...
                "sAjaxSource": baseURL + 'subject/subjects',
                "aoColumns": [{
                    "mData": "id",
                    "aTargets": [0]
                },{
            ...
            $("#btnSearch").click(function () {
                ...
                oSettings.sAjaxSource = baseURL + "subject/subjects?title=" + title +"&status="+status+"&startTime="+startTime+"&endTime="+endTime;

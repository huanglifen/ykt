                            ...
                            <div  action="#" class="form-horizontal">
                                <div class="row-fluid" >
                                    <div class="span8" id="jsMultiForm">
                                        ...
                                        <div id="multi_source_m0" data-key="0" class="multi_source">
                                            <div class="control-group">
                                                <label class="control-label">标题</label>
                                                <div class="controls">
                                                    <input type="text" name="title"
                                    ...
                                    <div class="span4 little_source">
                                        <div class="control-group" style="width:250px;color:#c0c0c0;margin:0 20px;border:1px solid #c0c0c0;">
                                            <div class="hover-mask current" id="little_box_li_m0" data-key="0" style="background-color: #f5f2f2; height:190px;margin:15px;">
                                               ...
                                               <div style="background-color: rgba(0,0,0,0.6);line-height:30px;padding-left:5px;" class="minTitle">标题</div>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            $("#jsPlusBox").on('click', function() {
                ...
                var formHtml = '<div style="display:none;" data-key="' + littleBox + '" id="multi_source_m' + littleBox + '" class="multi_source">';
            ...
            $("#JsSaveBtn").on('click', function() {
                ...
                $.each($source, function(i, item) {
                    ...
                    var data = {"title" : title, "url" : url, "pic" : pic, "content" : content};
                    source[key] = data;
                });
                if(num < 2) {
                    alert('至少要两条图文！');

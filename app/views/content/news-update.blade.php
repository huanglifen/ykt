                    ...
                    <div class="portlet-body form">
                        <form id="addContentForm" action="#" class="form-horizontal">
                                ...
                                <div class="controls">
                                    <select class="span7 chosen" tabindex="1" id="type" name="type">
                                        @foreach($contentType as $key => $value)
                                            <option value="{{{$key}}}" @if($content->type == $key) selected @endif>{{{$value}}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio">
                                        <input type="radio" name="display" value="1" @if($content->display != \App\Module\BaseModule::STATUS_CLOSE)checked @endif />
                                        是
                                    </label>
                                    <label class="radio">
                                        <input type="radio" name="display" value="2" @if($content->display == \App\Module\BaseModule::STATUS_CLOSE)checked @endif/>
                                        否
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls input-prepend" style="margin-left:20px;">
                                    ...
                                    <input class="span12 m-wrap m-ctrl-medium date-picker" name="startTime" id="startTime" readonly
                                           type="text" @if($content->start_time)value="{{{date("m/d/Y", $content->start_time)}}}" @endif/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls input-prepend" style="margin-left:20px;">
                                    ...
                                    <input class="m-wrap m-ctrl-medium date-picker" style="width:167px;" name="endTime"  id="endTime"  readonly
                                           type="text" @if($content->end_time) value="{{{date("m/d/Y", $content->end_time)}}}" @endif/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="source" name="source" value="{{{$content->source}}}"
                                           class="span6 m-wrap popovers" data-trigger="hover"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="author" name="author" value="{{{$content->author}}}"
                                           class="span6 m-wrap popovers" data-trigger="hover"/>
                                </div>
                            </div>
...
@section('otherJs')
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            var content = '<?php echo $content->content; ?> ';
            ue.ready(function() {

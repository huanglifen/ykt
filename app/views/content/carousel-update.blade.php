...
@section("context")
    ...
    <div class="container-fluid">
        ...
        $breadcrumb = array(
                ...
                array("编辑ETC和旅游页广告", $baseURL . '/carousel/update/'.$carousel->id),
        )
        ?>
                    ...
                    <div class="portlet-body form">
                        <div id="addProductForm" action="#" class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="span6 chosen" tabindex="1" id="type" name="type">
                                        <option value="{{{\App\Module\CarouselModule::TYPE_ETC}}}" @if($carousel->type == \App\Module\CarouselModule::TYPE_ETC)selected @endif>ETC页</option>
                                        <option value="{{{\App\Module\CarouselModule::TYPE_TRAVEL}}}" @if($carousel->type == \App\Module\CarouselModule::TYPE_TRAVEL)selected @endif>旅游页</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="large m-wrap" rows="3" name="remark" id="remark">{{{$carousel->remark}}}</textarea>
                                </div>
                            </div>

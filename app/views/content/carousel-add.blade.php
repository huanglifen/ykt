...
@section("context")
    ...
    <div class="container-fluid">
        <?php
        $breadTitle = "新增ETC和旅游页广告";
        $breadcrumb = array(
                array("内容管理"),
                array("ETC和旅游页广告", $baseURL . '/carousel/index/0'),
                array("新增ETC和旅游页广告", $baseURL . '/carousel/add/0'),
        )
        ?>
                    ...
                    <div class="portlet-body form">
                        <div id="addProductForm" action="#" class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="span6 chosen" tabindex="1" id="type" name="type">
                                        <option value="{{{\App\Module\CarouselModule::TYPE_ETC}}}">ETC页</option>
                                        <option value="{{{\App\Module\CarouselModule::TYPE_TRAVEL}}}">旅游页</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="large m-wrap" rows="3" name="remark" id="remark"></textarea>
                                </div>
                            </div>

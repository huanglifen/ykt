            ...
            <div class="span12">
                ...
                <div class="portlet box">
                    <div class="portlet-body">
                        <div class="clearfix">
                            <div class="btn-group">
                                <a href="{{{$baseURL}}}/carousel/add/{{{\App\Module\CarouselModule::TYPE_INDEX}}}" class="btn margin-right-10 green">
    ...
    <script>
        $(function () {
            ...
            var tbl = $('#datatable_carousel').dataTable({
                ...
                "sAjaxSource": baseURL + 'carousel/carousel?type='+<?php echo \App\Module\CarouselModule::TYPE_INDEX ?>,
                "aoColumns": [{
                    "mData": null,
                    "aTargets": [0],

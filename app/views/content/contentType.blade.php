            ...
            <div class="span12">
                ...
                <div class="portlet box">
                    <div class="portlet-body">
                        <div class="clearfix">
                            <div class="btn-group">
                                <a href="{{{$baseURL}}}/contentType/add" class="btn margin-right-10 green">
                                    新增<i class="icon-plus"></i>
                                </a>
                            </div>
                            <div class="control-group pull-right">
                                    <div class="input-append">
                                        <input class="m-wrap" type="text" id="keyword" placeholder="输入编号/名称"><button class="btn green" type="button" id="btnSearch" >搜索</button>
                                    </div>
                            </div>
                        </div>
                        <table class="table table-striped table-bordered table-hover" id="datatable_type">
                            <thead>
                            <tr>
                                <th style="width:25%">类型编号</th>
                                <th style="width:25%">类型名称</th>
                                <th style="width:25%">显示顺序</th>
    ...
    <script>
        $(function () {
            ...
            var tbl = $('#datatable_type').dataTable({
                ...
                "sAjaxDataProp": 'contentType',
                "sAjaxSource": baseURL + 'contentType/content-type',
                "aoColumns": [{
                    "mData": "number",
                    "aTargets": [0]
                }, {
                    ...
                    "fnRender" : function(obj) {
                        return '<span data-id="' + obj.aData.id + '"><a title="编辑" href="' + baseURL + 'contentType/update/' + obj.aData.id + '" class="btn mini green margin-right-10"><i class="icon-edit"></i></a><a title="删除" href="javascript:;" class="JsDelete btn mini red"><i class="icon-trash"></i></a></span>';
                    }
                }]
            });
            ...
            $("#btnSearch").click(function () {
                ...
                oSettings.sAjaxSource = baseURL + "contentType/content-type?keyword=" + keyword;
            ...
            $("body").on('click','.JsDelete', function(){
                ...
                $.ajax({
                    ...
                    'dataType' : 'json',
                    'data' : 'id='+id,
                    'url' : baseURL + 'contentType/delete',

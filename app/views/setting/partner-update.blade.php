...
@section("context")
    ...
    <div class="container-fluid">
        ...
        $breadcrumb = array(
                ...
                array("修改合作网站", $baseURL . '/partner/update/' . $id),
        )
        ?>
                    ...
                    <div class="portlet-body form">
                        <div id="addProductForm" action="#" class="form-horizontal">
                            ...
                            <div class="row-fluid">
                                <div class="span6 ">
                                    <div class="control-group" style="height:200px;border:1px solid #ccc;margin-left:180px;text-align:center;vertical-align: middle">
                                        <img id="jsPicImg" style="max-height: 190px;margin:5px;" src="{{{$baseURL}}}/{{{$partner->picture or ''}}}" data="{{{$partner->picture or ''}}}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio">
                                        <input type="radio" name="display" value="1" @if($partner->display != \App\Module\BaseModule::STATUS_CLOSE)checked @endif/>
                                        是
                                    </label>
                                    <label class="radio">
                                        <input type="radio" name="display" value="2" @if($partner->display == \App\Module\BaseModule::STATUS_CLOSE)checked @endif/>
                                        否
                                    </label>
                                </div>
                            </div>

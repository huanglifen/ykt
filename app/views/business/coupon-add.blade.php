...
@section("context")
    ...
    <div class="container-fluid">
        ...
        $breadcrumb = array(
                ...
                array("新增优惠券", $baseURL . '/coupon/add/'.$businessId),
        );
        ?>
                    ...
                    <div class="portlet-body form">
                        <div id="addCouponForm" action="#" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="title" name="title" class="span6 m-wrap popovers" data-trigger="hover"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <textarea class="large m-wrap" rows="3" name="content" id="content"></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">优惠券数量</label>
                                <div class="controls">
                                    <input type="text" id="amount" name="amount" class="span6 m-wrap popovers" data-trigger="hover"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">剩余数量</label>
                                <div class="controls">
                                    <input type="text" id="remainAmount" name="remainAmount" class="span6 m-wrap popovers" data-trigger="hover"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">开始时间</label>
                                <div class="controls">
                                    <input class="m-wrap m-ctrl-medium date-picker" id="startTime" name="startTime" readonly size="16" type="text" value=""  placeholder="请输入开始时间"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">结束时间</label>
                                <div class="controls">
                                    <input class="m-wrap m-ctrl-medium date-picker"id="endTime"  name="endTime" readonly size="16" type="text" value=""  placeholder="请输入结束时间"/>
                                </div>
                            </div>
                            <div class="control-group">

            ...
            <div class="span12">
                ...
                <div class="portlet box">
                    <div class="portlet-body">
                        <div class="clearfix">
                            <div class="btn-group">
                                <a href="{{{$baseURL}}}/coupon/add/{{{$businessId}}}" class="btn margin-right-10 green">
                                    ...
                                    <div class="control-group">
                                        <form action="#" class="form-search">
                                            <div class="input-append">
                                                <input class="m-wrap" type="text" id="keyword" placeholder="优惠券名称"><button class="btn green btnSearch" type="button" id="btnSearch" >搜索</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    <script>
        $(function () {
            ...
            var tbl = $('#datatable_activity').dataTable({
                ...
                "sAjaxDataProp": 'coupon',
                "sAjaxSource": baseURL + 'coupon/coupon/'+businessId,
                "aoColumns": [{
                    "mData": "id",
                    "aTargets": [0]
                },{
                    ...
                    "aTargets": [3],
                    "fnRender" : function(obj) {
                        return '<span data-id="' + obj.aData.id + '"><a title="编辑" href="' + baseURL + 'coupon/update/'+businessId+"/" + obj.aData.id + '" class="btn mini green margin-right-10"><i class="icon-edit"></i></a><a title="删除" href="javascript:;" class="JsDelete btn mini red"><i class="icon-trash"></i></a></span>';
                    }
                }]
            });
            $("#btnSearch").click(function () {
                ...
                oSettings.sAjaxSource = baseURL + "coupon/coupon/"+businessId+"?keyword=" + keyword;

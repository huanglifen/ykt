...
@section("context")
    ...
    <div class="container-fluid">
        ...
        $breadcrumb = array(
                ...
                array("编辑用户", $baseURL . '/user/update/'.$user->id))
        ?>
                    ...
                    <div class="portlet-body form">
                        <form id="updateUserForm" action="#" class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 m-wrap"  disabled value="{{{$user->name}}}"/>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio">
                                        <input type="radio" name="status" value="{{{\App\Module\UserModule::STATUS_OPEN}}}" @if($user->status != \App\Module\UserModule::STATUS_CLOSE )checked @endif />
                                        是
                                    </label>
                                    <label class="radio">
                                        <input type="radio" name="status" value="{{{\App\Module\UserModule::STATUS_CLOSE}}}" @if($user->status == \App\Module\UserModule::STATUS_CLOSE )checked @endif />
                                        否
                                    </label>
                                </div>
                            </div>

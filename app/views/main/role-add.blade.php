            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-body form">
                        <form id="addRoleForm" action="#" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="large m-wrap" rows="3" id="description" name="description"></textarea>
                                </div>
                            </div>
                            <div class="control-group">
